...
for feature in model_features:
    if feature == 'Pclass':
        input_data[feature] = st.selectbox('Pclass:', [1, 2, 3], key=feature)
    elif feature == 'Age':
        input_data[feature] = st.slider('Age:', 0, 100, 30, key=feature)
    elif feature == 'SibSp':
        input_data[feature] = st.slider('SibSp:', 0, 8, 0, key=feature)
    elif feature == 'Parch':
        input_data[feature] = st.slider('Parch:', 0, 6, 0, key=feature)
    elif feature == 'Fare':
        input_data[feature] = st.slider('Fare:', 0.0, 500.0, 50.0, key=feature)
    elif feature == 'Sex_male':
        input_data[feature] = st.selectbox('Sex:', ['female', 'male'], key=feature)
    elif feature == 'Embarked_Q':
        input_data[feature] = st.selectbox('Embarked_Q:', [False, True], key=feature)
    elif feature == 'Embarked_S':
        input_data[feature] = st.selectbox('Embarked_S:', [False, True], key=feature)
